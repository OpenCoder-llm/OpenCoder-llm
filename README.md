...
## News
- 🔥🔥🔥 ```2024/12/08``` We have released our pretraining data cleaning pipeline: [opc_data_filtering](https://github.com/OpenCoder-llm/opc_data_filtering). Try to use this framework to create your own high-quality code pretraining corpus!
